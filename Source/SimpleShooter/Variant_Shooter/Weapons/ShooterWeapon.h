 ...
 */
UCLASS(abstract)
class SIMPLESHOOTER_API AShooterWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(ReplicatedUsing = OnRep_MagazineSize, EditAnywhere, Category="Ammo", meta = (ClampMin = 0, ClampMax = 100))
